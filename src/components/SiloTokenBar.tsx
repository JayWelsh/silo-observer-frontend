  ...
  return (
    <Bar
      style={siloTokenData ? {
        ...
        background: Number(siloTokenData.change_24hr_usd_percent) >= 0 ? "linear-gradient(0deg, rgba(1,29,0,1) 0%, rgba(0,0,0,1) 100%)" : "linear-gradient(0deg, rgba(30,0,0,1) 0%, rgba(0,0,0,1) 100%)"
      } : {}}
    >
      {isConsideredMobile && 
      <>
